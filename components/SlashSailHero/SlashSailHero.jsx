...
export const SlashSailHero = ({
  image_on_right,
  image_url = 'https://res.cloudinary.com/drw/image/upload/c_fill,g_face,q_auto,f_auto,w_380,h_480/v1636127712/comm-drw/uploads/cumberland_traders_yrobwy.jpg',
        ...
        <div class='px-5 py-12 md:py-28 lg:py-32 grid grid-cols-1 md:grid-cols-2 sm:gap-x-5'>
          <div
            class={`self-start ${
              image_on_right
                ? 'order-last md:pl-14'
                : 'order-last md:order-first md:pr-14'
            }`}
          >
            <div class='mb-6 w-64 transform translate-x-4 md:-translate-x-10 h-[350px] sm:w-80 lg:w-96 md:h-[480px] mt-8 md:mt-0 mx-auto relative'>
              ...
              <img
                class='absolute w-[380px] h-[350px] sm:w-80 lg:w-96 md:h-[480px] backslash-60 inset-0 object-cover transform -translate-x-6'
                src={image_url}
                alt={image_alt}
              />
            </div>
          ...
          <div class='mt-10 md:mt-0 flex py-4 flex-col justify-center'>
            ...
            <div
              class={`text-base lg:text-xl prose mt-6 ${
